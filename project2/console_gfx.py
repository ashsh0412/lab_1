...
def display_image(image_data):
    ...
    for y_index in range(0, height, 2):
        ...
        for x_index in range(width):
            ...
            output_str += fg_palette[
                TRANS_DISPLAY if output_color == CLEAR else output_color
            ]
            output_color = (
                image_data[data_index + width] if y_index + 1 < height else CLEAR
            )
            output_str += bg_palette[
                TRANS_DISPLAY if output_color == CLEAR else output_color
            ]
            output_str += "▀"
            data_index += 1
